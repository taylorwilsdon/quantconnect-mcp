...
class QuantConnectAuth:
    ...
    def __init__(self, user_id: Optional[str] = None, api_token: Optional[str] = None, organization_id: Optional[str] = None):
        """
        ...
        self.organization_id = organization_id or os.getenv("QUANTCONNECT_ORGANIZATION_ID")
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    return False, "Authentication failed: Invalid credentials or expired timestamp"
                else:
...
def get_auth_headers() -> Dict[str, str]:
    ...
    if _auth_instance is None:
        raise ValueError("QuantConnect authentication not configured. Call configure_auth() first.")
    
    return _auth_instance.get_headers()

def configure_auth(user_id: Optional[str] = None, api_token: Optional[str] = None, organization_id: Optional[str] = None) -> QuantConnectAuth:
    """
